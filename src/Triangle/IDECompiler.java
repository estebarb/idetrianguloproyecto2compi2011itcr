 ...
 */
/*
 * LDC: Control de cambios
 * 27/5     - Se deshabilitó Checker y Encoder en la compilación.
 */
...
public class IDECompiler {
    ...
    public boolean compileProgram(String sourceName) {
        ...
        scanner.enableDebugging(); //DONE: Activa el debugging
        
        report = new IDEReporter();
        Parser parser = new Parser(scanner, report);
        boolean success = report.numErrors== 0;
        ...
        if (success) // DONE: Modificación del mensaje de 
            System.out.println("Compilation was successful. Sin Checker ni Encoder");
        else
