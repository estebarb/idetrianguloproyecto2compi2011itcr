 ...
 * 27/5     - Se eliminaron "import"s para aclarar el código
 * 27/5     - 
 * 
 */
...
import Triangle.AbstractSyntaxTreesP2.*;
...
public class TreeVisitor implements Visitor {
    ...
    // ******************************************************************
    // TODO: Nuestras modificaciones
    // ******************************************************************
    // Visitantes para repeat * ----------------------------------------
    @Override
    ...
    public Object visitLoopCommand(LoopCommand ast, Object o) {
        return (createBinary("Repeat Loop Command", ast.I, ast.C));
    }
    
    @Override
    public Object visitLoopNoIdentifierCommand(LoopCommand ast, Object o) {
        return (createUnary("Repeat Loop (no id) Command", ast.C));
    }

    // Visitantes para for var * ----------------------------------------
    @Override
    public Object visitForDoCommand(ForDoCommand ast, Object o) {
        return (createQuaternary("For Do Command", ast.I, ast.Eini, ast.Efin, ast.C));
    }

    @Override
    public Object visitForWhileDoCommand(ForWhileDoCommand ast, Object o) {
        return (createQuinary("For While Do", ast.I, ast.Eini, ast.Efin, ast.Econd, ast.C));
    }

    @Override
    public Object visitForUntilDoCommand(ForUntilDoCommand ast, Object o) {
        return (createQuinary("For Until Do", ast.I, ast.Eini, ast.Efin, ast.Econd, ast.C));
    }

    // Visitantes para exit, next
    @Override
    public Object visitExitCommand(ExitCommand ast, Object o) {
        return (createNullary("Exit Command"));
    }
